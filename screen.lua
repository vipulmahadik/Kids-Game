...
function scene:createScene(event)
	...
	local alphabets={
		...
		{title="E",images={"images/figs.jpg","images/fox.jpg","images/bluerose.jpg","images/fish.jpg"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Eggplant", "Elephant", "Euphorbia", "Endive"}},
		{title="F",images={"images/figs.jpg","images/fox.jpg","images/bluerose.jpg","images/fish.jpg"},audios={"sounds/figs.mp3","sounds/fox.mp3","sounds/blue_rose.mp3","sounds/fish.mp3"},label={"Figs", "Fox", "Fern", "Fish"}},
		...
		{title="I",images={"images/jackfruit.jpg","images/jellyfish.jpg","images/jasmine.jpg","images/jujube.jpg"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Ice Plant", "Impala", "Indigo", "Iceberg Lettuce"}},
		...
		{title="N",images={"images/nutmeg.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/nutmeg.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Nutmeg", "Nilgai", "Nannyberry", "Nectarine"}},
		...
		{title="Q",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Quince", "Quail", "Queen Lily Ginger", "Quandong"}},
		{title="R",images={"images/banana.jpg","images/rabbit.jpg","images/rose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/rabbit.mp3","sounds/rose.mp3","sounds/brinjal.mp3"},label={"Raspberry", "Rabbit", "Rose", "Radish"}},
		{title="S",images={"images/strawberry.jpg","images/bear.jpg","images/sunflower.jpeg","images/brinjal.png"},audios={"sounds/strawberry.mp3","sounds/bear.mp3","sounds/sunflower.mp3","sounds/brinjal.mp3"},label={"Strawberry", "Snake", "Sunflower", "Spinach"}},
		...
		{title="U",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Ugli", "Umbrellabird", "Ursinia", "Ulluco"}},
		{title="V",images={"images/vanilla.jpg","images/Vulture.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/vanilla.mp3","sounds/vulture.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Vanilla", "Vulture", "Valerian", "Velvet Bean"}},
		{title="W",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Waterberry", "Walrus", "Waterlily", "Watercress"}},
		{title="X",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Ximenia", "Xantus", "Xenia", "Xigua"}},
		{title="Y",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Yam", "Yak", "Yucca", "Yam Beans"}},
		{title="Z",images={"images/banana.jpg","images/bear.jpg","images/bluerose.jpg","images/brinjal.png"},audios={"sounds/banana.mp3","sounds/bear.mp3","sounds/blue_rose.mp3","sounds/brinjal.mp3"},label={"Zebu", "Zebra", "Zebra Plant", "Zucchini"}},
	}
